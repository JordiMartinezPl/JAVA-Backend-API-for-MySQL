...
public class CarRestController {
    ...
    public ResponseEntity<CarDTO> createCar(@RequestBody CarDTO carToCreate) throws Exception {
        CarDTO createdCar = new CarController().createNewCar(carToCreate);
